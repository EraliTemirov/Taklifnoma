...
const Countdown = ({date}) => {
  ...
  Object.keys(timeLeft).forEach((interval) => {
    timerComponents.push(
      <div key={interval} className='flex flex-col items-center'>
        <span className='text-3xl sm:text-4xl font-semibold'>{timeLeft[interval]}</span>
  ...
  return (
    <div className='countdown text-center py-10 px-4 sm:px-6 lg:px-8'>
      ...
      <p className='text-md sm:text-lg md:text-xl text-gray-600 mb-2'>NIKOH OQSHOMIGACHA QOLDI:</p>
