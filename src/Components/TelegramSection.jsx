  ...
  return (
    <div className='telegram-section text-center my-8 opacity-0 px-4 sm:px-6 lg:px-8'>
      <p className='special-font text-gray-700 mb-4'>
        Barcha rasm va videolar bilan ushbu Telegram guruhda bolishganiz juda mamnun bolar edik!
      </p>
      ...
      <p className='text-gray-700 special-font'>NIKOH SHODIYONAMIZDA KORISHGUNCHA!</p>
